...
=========================================================================*/
  ...
  $("#project-single-carousel2").owlCarousel({
    loop: true,
    margin: 5,
    autoplay: true,
    smartSpeed: 500,
  ...
  $("#project-single-carousel3").owlCarousel({
    loop: true,
    margin: 5,
    autoplay: true,
    smartSpeed: 500,
  ...
  $("#project-single-carousel4").owlCarousel({
    loop: true,
    margin: 5,
    autoplay: true,
    smartSpeed: 500,
  ...
  $("#project-single-carousel5").owlCarousel({
    loop: true,
    margin: 5,
    autoplay: true,
    smartSpeed: 500,
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  function error() {
    ...
    console.log("Error on send form");
  }
